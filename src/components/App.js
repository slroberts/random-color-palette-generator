  ...
  render() {
    return (
      <div className='md:container md:mx-auto p-4'>
        ...
        <Prompt
          classes='mt-12 md:w-4/12 w-full flex justify-center px-8 py-3 text-base text-center rounded-full text-black bg-white md:py-4 md:text-sm m-auto border border-gray-200'
